...
class StatisticsSheetNavigationManager {
  ...
  List<Widget> buildItems(Function(String) onModalBottomSheetMenuTapped) => [
    SectionLink(
      ...
      onTap: () => onModalBottomSheetMenuTapped(BeerPlayerStatisticScreen.id),
    ),
    SectionLink(
      icon: Icons.wine_bar,
      title: const Text("Statistiky piv zápasu"),
      onTap: () => onModalBottomSheetMenuTapped(BeerMatchStatisticScreen.id),
    ),
    SectionLink(
      icon: Icons.attach_money,
      title: const Text("Statistiky pokut hráče"),
      onTap: () => onModalBottomSheetMenuTapped(FinePlayerStatisticScreen.id),
    ),
    SectionLink(
      icon: Icons.savings,
      title: const Text("Statistiky pokut v zápase"),
      onTap: () => onModalBottomSheetMenuTapped(FineMatchStatisticScreen.id),
    ),
    SectionLink(
      icon: Icons.sports,
      title: const Text("Statistiky gólů hráče"),
      onTap: () => onModalBottomSheetMenuTapped(GoalPlayerStatisticScreen.id),
    ),
    SectionLink(
      icon: Icons.sports_soccer,
      title: const Text("Statistiky gólů v zápase"),
      onTap: () => onModalBottomSheetMenuTapped(GoalMatchStatisticScreen.id),
    ),
    SectionLink(
      icon: Icons.groups_rounded,
      title: const Text("Účast hráčů na zápasech"),
      onTap: () =>
          onModalBottomSheetMenuTapped(AttendancePlayerStatisticScreen.id),
    ),
    SectionLink(
      icon: Icons.event_available_rounded,
      title: const Text("Počet hráčů v zápasech"),
      onTap: () =>
          onModalBottomSheetMenuTapped(AttendanceMatchStatisticScreen.id),
    ),
    const MenuSectionLabel(text: "PODROBNÉ PŘEHLEDY"),
    SectionLink(
      icon: Icons.query_stats,
      title: const Text("Detail piv"),
      onTap: () => onModalBottomSheetMenuTapped(BeerDetailStatsScreen.id),
    ),
    MenuSectionLabel(
      text:
    ...
    SectionLink(
      ...
      onTap: () => onModalBottomSheetMenuTapped(FootballStatsScreen.id),
    ),
    SectionLink(
