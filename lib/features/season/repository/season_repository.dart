...
final seasonRepositoryProvider = Provider(
  (ref) => SeasonRepository(firestore: FirebaseFirestore.instance),
);

class SeasonRepository extends CustomFirebaseException {
  ...
  Future<bool> addSeason(BuildContext context, String name, DateTime fromDate,
  ...
  Future<bool> editSeason(BuildContext context, String name, DateTime fromDate,
      DateTime toDate, SeasonModel seasonModel) async {
    try {
