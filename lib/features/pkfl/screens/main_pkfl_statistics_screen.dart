...
class _MainPkflStatisticsScreenState
  ...
  void updatePlayerStats() {
    ref.read(pkflStatsControllerProvider).setPkflPlayerStats(currentSeason, selectedValue ??
        SpinnerOption.values[0], orderDescending, _searchController.text);
  }
                        ...
                        builder: (context, stringSnapshot) {
                          return Center(
                            child: CircularPercentIndicator(
                              ...
                              center: Text(stringSnapshot.data?.text ?? "Načítám...", textAlign: TextAlign.center),
                                          ...
                                          InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              child: ListTile(
                                                ...
                                                subtitle: Text(
                                                  player.toStringBySpinnerOption(
                                                      selectedValue ??
                                                          SpinnerOption.values[0]),
                                                  style: const TextStyle(
